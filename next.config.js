    ...
    return [
      {
        ...
        headers: [
          ...
          ...(process.env.NODE_ENV === 'production' ? [{
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://yandex.ru https://api-maps.yandex.ru https://*.yandex.ru https://*.yandex.net https://vercel.live https://*.vercel.live",
              ...
              "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api-maps.yandex.ru https://*.yandex.ru https://*.yandex.net https://k-c-reservations.vercel.app https://*.vercel.app https://vercel.live https://*.vercel.live",
              "media-src 'self'",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self'",
