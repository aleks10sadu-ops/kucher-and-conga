    ...
    return [
      {
        ...
        headers: [
          ...
          ...(process.env.NODE_ENV === 'production' ? [{
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' http://localhost:* ws://localhost:* wss://localhost:* https://yandex.ru https://api-maps.yandex.ru https://*.yandex.ru https://*.yandex.net https://vercel.live https://*.vercel.live",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://*.yandex.ru",
              "img-src 'self' data: blob: https: http:",
              "font-src 'self' https://fonts.gstatic.com data:",
              "frame-src 'self' https://yandex.ru https://*.yandex.ru https://*.yandex.kz",
              "connect-src 'self' http://localhost:* ws://localhost:* wss://localhost:* https://*.supabase.co wss://*.supabase.co https://api-maps.yandex.ru https://*.yandex.ru https://*.yandex.net https://k-c-reservations.vercel.app https://*.vercel.app https://vercel.live https://*.vercel.live",
              "media-src 'self'",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self'"
