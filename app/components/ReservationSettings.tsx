...
type ReservationSettingRow = Database['public']['Tables']['reservation_settings']['Row'];
...
export default function ReservationSettings({ isOpen, onClose }: ReservationSettingsProps) {
    ...
    const fetchSettings = async () => {
        ...
        try {
            ...
            const settingsData = data as unknown as ReservationSettingRow[];

            const datesRow = settingsData.find((s) => s.key === 'restricted_dates');
            const timesRow = settingsData.find((s) => s.key === 'restricted_times');
            const scheduleRow = settingsData.find((s) => s.key === 'standard_schedule');


            // Cast Json to specific types
            const dates = (datesRow?.value as unknown as string[]) || [];
            const times = (timesRow?.value as unknown as Record<string, string[]>) || {};
            const schedule = (scheduleRow?.value as unknown as Schedule) || { start: '10:00', end: '00:00' };
        ...
        try {
            ...
            const { error: error1 } = await supabase
                ...
                .upsert({
                    ...
                    value: restrictedDates as unknown as any, // Cast to any to satisfy Json type constraint if strict
                    created_at: undefined // Optional in Insert
            ...
            const { error: error2 } = await supabase
                ...
                .upsert({
                    ...
                    value: restrictedTimes as unknown as any,
            ...
            const { error: error3 } = await supabase
                ...
                .upsert({
                    ...
                    value: standardSchedule as unknown as any,
                    created_at: undefined
                } as any, { onConflict: 'key' });
