...
type HomeClientProps = {
  // Меню, отрендеренное на сервере (SSR) — URL картинок попадают в HTML сразу,
  // поэтому браузер/Next начинают грузить изображения без клиентского водопада.
  ssrMenuData?: Record<string, { categories: any[] }>;
};

export default function HomeClient({ ssrMenuData }: HomeClientProps) {
