...
// Define Post interface locally or import it if we move it to a shared file later.
// For now, local definition to ensure self-containment for this page.
interface Post {
    id: string;
    slug: string;
    title: string;
...
export default function BlogPage() {
    ...
    const checkAdmin = async () => {
        try {
            const supabase = createSupabaseBrowserClient() as any; // Cast to any for robust type handling
            if (!supabase) {
    ...
    const loadPosts = async () => {
        setLoading(true);
        try {
            const supabase = createSupabaseBrowserClient() as any; // Cast to any
            if (!supabase) {
                setLoading(false);
                return;
            }
